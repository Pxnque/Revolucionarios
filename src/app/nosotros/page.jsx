...
const page = () => {
  return (
    ...
    <div className="w-auto border border-black mx-16 mb-4"></div>
    <div className="flex flex-col md:flex-row md:items-center">
    <div className="md:w-4/6 flex items-center justify-center">
    <Image src="/1714104245669.jpg" alt="imagen" width={280} height={180} className="md:w-4/6 md:m-12 rounded-md"></Image>
    </div>
    <div className="md:w-1/2 my-4 mx-6 flex-col items-center justify-center">
    <p className="text-base md:text-2xl text-center">
    En Los Revolucionarios, nuestra pasión por la cocina es el punto de partida, y esta pasión se enciende con la elección meticulosa de ingredientes frescos y de la más alta calidad.</p>
    <p className="text-base md:text-2xl text-center hidden lg:block">
